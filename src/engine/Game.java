...
public class Game {
	...
	public boolean archeryRange = false;
	public boolean barracks = false;
	public boolean attackFlag = false;
	public boolean seigeFlag = false;
	public String res="";
	public Army tempArmy;
	...
	public void targetCity(Army army, String targetName) throws FriendlyCityException {
		for (City xCity : this.getPlayer().getControlledCities())
			if (xCity.getName().equals(targetName))
				throw new FriendlyCityException("You cannot target this city as you control it");
