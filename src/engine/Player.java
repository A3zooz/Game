...
public class Player {
	...
	public void build(String type, String cityName) throws NotEnoughGoldException, AlreadyBuildException {
		for (City c : controlledCities) {
			if (c.getName().equals(cityName)) {
				Building b = null;
				...
				if (type.equals("farm") || type.equals("market")) {
					for (EconomicBuilding e : c.getEconomicalBuildings()) {
						if (e instanceof Farm && type.equals("farm") || e instanceof Market && type.equals("market"))
							throw new AlreadyBuildException("You already have this building");
					}
				} else {
					{
